...
function AccountPage() {
  ...
  if (!currentUser) {
    // This should not normally happen because of the PrivateRoute
      ...
      <div className="col-md-8 col-lg-6 account-wrapper">
        <div className="card shadow-sm border-0">
          <div className="card-body">
            <h3 className="card-title mb-3">My Account</h3>
            <p className="text-muted mb-4">
              Keep your contact details current so we can recognise you next time you log in.
            </p>
