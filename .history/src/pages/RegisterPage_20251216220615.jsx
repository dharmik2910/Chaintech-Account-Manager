...
function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!password) {
      ...
      newErrors.password = 'Password is Weak - Add uppercase, numbers, or special characters'
    }
          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="mb-3">
                ...
                {password && (
                  <div className="password-strength-container mt-2">
                    ...
                    <small
                      ...
                      style={{ color: passwordStrength.color, fontWeight: 700 }}
                    >
                ...
                <div className="mt-2">
                  <Link to="/login" className="link-primary" style={{ fontSize: '0.85rem' }}>
                    Forgot Password?
                  </Link>
                </div>
                {errors.password && (
